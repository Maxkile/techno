...
imsize = 450 if torch.cuda.is_available() else 128  # use small size if no gpu
...
style_img = image_loader("/home/maxkile/Docs/Progs/git/python/src/Font.jpg")
content_img = image_loader("/home/maxkile/Docs/Progs/git/python/src/Olya.jpg")
...
plt.figure()
imshow(input_img, title='Hof-tGwC1r4.jpg')
